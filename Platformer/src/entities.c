...
{
	switch (getLevelNo()) { //Added
	case(1):
		loadEnts("data/entslvl1.dat");
		break;
	case(2):
		loadEnts("data/entslvl2.dat");
		break;
	case(3):
		loadEnts("data/entslvl3.dat");
		break;
	case(4):
		loadEnts("data/entslvl4.dat");
		break;
	}
}
...
static void addEntFromLine(char *line)
{
	...
	else if (strcmp(name, "CHEESE") == 0) //added
	{
		initPizza(line);
	}
	else if (strcmp(name, "SPIKE") == 0) //added
	{
		initSpike(line);
	}
	else if (strcmp(name, "MTRAP") == 0) { //added
		initMTrap(line);
	}
	else if (strcmp(name, "JAR") == 0) { //added
		initJar(line);
	}
	else if (strcmp(name, "HEART") == 0) { //added
		initLife(line);
	}
	else if (strcmp(name, "BCHEESE") == 0) { //added
		initBCheese(line);
	}
	else
	{
